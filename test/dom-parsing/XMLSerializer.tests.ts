...
describe('XMLSerializer', () => {
	...
	it('can serialize a CDATASection', () => {
		...
		chai.assert.equal(
			serializer.serializeToString(document.createCDATASection('<element><!-- not a comment --></element>')),
		...
		chai.assert.equal(serializer.serializeToString(invalidCDataSection), '<![CDATA[test]]><not-an-element>]]>');
	});

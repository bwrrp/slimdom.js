...
// @public
declare function serializeToWellFormedString(root: Node): string;
...
// @public
declare function unsafeAppendAttribute(attribute: Attr, element: Element): void;

// @public
declare function unsafeCreateAttribute(namespace: string | null, prefix: string | null, localName: string, value: string, ownerElement: Element | null): Attr;

// @public
declare function unsafeCreateElement(document: Document, localName: string, namespace: string | null, prefix?: string | null): Element;

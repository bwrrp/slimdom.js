	...
	function(
		...
		Range.prototype.detach = function() {
			...
			var document = this.startContainer.ownerDocument || this.startContainer,
				rangeIndex = document.ranges.indexOf(this);
			document.ranges.splice(rangeIndex, 1);
		...
		Range.prototype.setStartBefore = function(referenceNode) {
			this.setStart(referenceNode.parentNode, util.getNodeIndex(referenceNode));
		};
		...
		Range.prototype.setStartAfter = function(referenceNode) {
			this.setStart(referenceNode.parentNode, util.getNodeIndex(referenceNode) + 1);
		};
		...
		Range.prototype.setEndBefore = function(referenceNode) {
			this.setEnd(referenceNode.parentNode, util.getNodeIndex(referenceNode));
		};
		...
		Range.prototype.setEndAfter = function(referenceNode) {
			this.setEnd(referenceNode.parentNode, util.getNodeIndex(referenceNode) + 1);
		};

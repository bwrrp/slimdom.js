...
/**
 * As we're already testing against Name, testing QName validity can be reduced to checking if the name contains at
 * most a single colon which is not at the first or last position.
 *
 * @param name The name to check
 *
